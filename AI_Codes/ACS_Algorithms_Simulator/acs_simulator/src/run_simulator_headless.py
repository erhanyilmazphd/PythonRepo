...
def run_experiment(config: SimulationConfig, experiment_name: str):
    ...
    # Save figure
    filename = os.path.join(output_dir, f"results_{experiment_name}.png")
    ...
    json_filename = os.path.join(output_dir, f"stats_{experiment_name}.json")
...
def main():
    ...
    # Save comparison
    output_dir = get_output_dir()
    comparison_filename = os.path.join(output_dir, "comparison_all_experiments.json")
